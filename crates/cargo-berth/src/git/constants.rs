...
/// Disable rename detection through the merge strategy option boundary.
pub(super) const GIT_STRATEGY_OPTION_NO_RENAMES_ARG: &str = "-Xno-renames";
/// Ask `merge-tree` to write its result tree object.
