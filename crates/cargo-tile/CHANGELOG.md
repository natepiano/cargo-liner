...
- Write along the foot of every cell what its contents ask for against the rows the cell was given -- `content rows: ## cell rows: ##` -- the first count green while it fits and red once it does not.
