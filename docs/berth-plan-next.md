...
- [ ] **Split `drift/` into submodules and move its constants into `constants.rs`**
  ...
  - Revealed by: Phase 9; evidence corrected after Phase 9b, Phase 10, and Phase 12
